...
document.querySelector(".check").addEventListener("click", function () {
  ...
  if (!guess) {
    ...
    displayMessage("Bravo vous avez trouver");
    ...
    if (score > 1) {
      // document.querySelector(".message").textContent = guess > secretNumber ? "Trop grand !" : "Trop petit !" ;
      ...
      displayMessage("TU PERDS FREROT");
